...
//
// Upon completion, this function will return the number of ingredients in
// the selected order.
//
...
// - the number of ingredients now in the selected order.
...
//
// The orders should be printed in the order they are in the linked
// list.
//
// If the pizzeria contains no orders, nothing should be printed
//
